...
@section('content')
    <div class="container">
        <h1 class="title">
            {{ __('Editar') }}
            <button type="button" class="btn btn-success submit-form float-right" data-form-id="userForm">{{ __('Salvar') }}</button>
            @if(isset($users[0]['id']))
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-md-12">
                <div class="card shadow-sm">
                    ...
                    @endif
                    @if(isset($users[0]['id']))
                        <form id="userForm" action="{{ route('updateUser', ['id' => $users[0]['id']]) }}" method="POST">
                            @csrf
                            <div class="card-body">
