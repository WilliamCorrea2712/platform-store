...
Route::middleware(['web', BreadcrumbMiddleware::class])->group(function () {
    ...
    Route::middleware([AuthenticateWithApi::class])->group(function () {
        ...
        Route::delete('/user/deleteUser', [UserController::class, 'deleteUser'])->name('deleteUser');
        ...
        Route::delete('/account/deleteAddress', [CustomerController::class, 'deleteAddress'])->name('deleteAddress');
        Route::delete('/account/deleteCustomer', [CustomerController::class, 'deleteCustomer'])->name('deleteCustomer');
        ...
        Route::delete('/product/deleteCategory', [CategoryController::class, 'deleteCategory'])->name('deleteCategory');
        ...
        Route::delete('/product/deleteBrand', [BrandController::class, 'deleteBrand'])->name('deleteBrand');
        ...
        Route::delete('/product/deleteProduct', [ProductController::class, 'deleteProduct'])->name('deleteProduct');
        Route::delete('/product/deleteStock', [ProductController::class, 'deleteStock'])->name('deleteStock');
        ...
        Route::delete('/product/deleteImage', [ProductController::class, 'deleteImage'])->name('deleteImage');
        ...
        Route::delete('/product/deleteListProduct', [ListProductController::class, 'deleteListProduct'])->name('deleteListProduct');

        Route::get('/getSetting', [SettingController::class, 'getSetting'])->name('getSetting');
        Route::post('/updateSetting/{id}', [SettingController::class, 'update'])->name('updateSetting');
